                        ...
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="2" data-masterspeed="500" data-thumb="homeslider_thumb1.jpg"  data-saveperformance="on"  data-title="Intro Slide">
                                ...
                                <div class="tp-caption lft skewtoleftshort rs-parallaxlevel-9"
                                    ...
                                    font-size: 36px;
                                    font-weight: bold;
                                    text-transform: uppercase;	color: #343434;">Home <span class="ss-color" style="color:#d6644a;">Houses</span></div>
                                <div class="tp-caption lft skewtoleftshort rs-parallaxlevel-9"
                                    data-x="center"
                                    data-y="310"
                                    data-speed="1000"
                            ...
                            <li data-transition="fade" data-slotamount="2" data-masterspeed="500" data-thumb="homeslider_thumb1.jpg"  data-saveperformance="on"  data-title="Intro Slide">
                                ...
                                <div class="tp-caption lft skewtoleftshort rs-parallaxlevel-9"
                                    ...
                                    font-size: 36px;
                                    font-weight: bold;
                                    text-transform: uppercase;	color: #343434;">Best <span class="ss-color" style="color:#d6644a;">Deals</span>
                                </div>
                                <div class="tp-caption lft skewtoleftshort rs-parallaxlevel-9"
                                    data-x="center"
                                    data-y="310"
